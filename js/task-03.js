...
const listgalary = document.querySelector('ul.gallery');
console.log(listgalary);

const createitem = function ({ url, alt } = {}) {
    console.log(url);
    console.log(alt, '\n\n');
    return `
...
const listItemGalary = images.map(item => createitem(item));
console.log(listItemGalary.join('\n'));

listgalary.insertAdjacentHTML('afterbegin', listItemGalary.join(''));